    ...
    <aside className="w-64 bg-navy-primary text-white h-full fixed top-0 left-0 overflow-y-auto shadow-xl z-10 flex flex-col">
      <div className="p-6 border-b border-white/10 flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-white/50">Dispatcher Portal</p>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-white/10">
        <div className="flex items-center">
            <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center text-xs font-bold">DP</div>
            <div className="ml-3">
